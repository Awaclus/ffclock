...
const Clock = () => {
  ...
  const pt1 = new Date("2027-01-09T18:55:00.000Z");
  const pt2 = new Date("2027-01-09T21:37:04.000Z");
  const pt3 = new Date("2027-01-10T00:42:22.000Z");
  const end = new Date("2027-01-10T03:03:06.000Z");
  const next = new Date("2028-01-09T16:55:00.000Z");
...

{
            ...
            <p>(and don't forget Kara no Kyoukai on Feb 27 and Mar 6, 19:00 UTC!)</p>
        </div>
      }
      ...
      <p>The schedule might be preponed by two hours if Kaiten is available by the time I'm encoding the stream (seems unlikely).</p>
    </div>
  );
